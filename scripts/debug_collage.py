...
2. Live API Mode (--live): Real Last.fm queries and web retrieval using credentials from .env.
"""
...
def main() -> int:
    ...
    print("=" * 65)
    print(f" • Mode        : {'OFFLINE MOCK (Synthetic Tiles)' if is_mock else 'LIVE API (Last.fm & Retrieval)'}")
