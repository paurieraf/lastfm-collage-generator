...
Provides synthetic image generation, pylast entity mocking, and HTML scraping
...
class MockHtmlScraperResponses:
    """Simulated HTML responses for Last.fm artist web scraping."""
